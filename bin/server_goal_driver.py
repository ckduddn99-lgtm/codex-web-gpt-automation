...
def build_prompt(
    ...
    return (
        ...
        "- The chatgpt assignee must use an ordinary ChatGPT web chat/browser session only; never select or route implementation through ChatGPT Worker, Codex Worker, or codex exec.\n"
        "- Use codex and claude only for independent review/cross-check tasks after ChatGPT implementation, and never as a substitute implementation path.\n"
